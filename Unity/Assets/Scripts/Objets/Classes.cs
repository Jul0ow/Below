...
public class Classes : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        AllItem[0].Add(7,Item.CreateItem("Infinite","Il n'y a que de choses infinies, l'univers et mes balles !", CommonImage, Infi,Effect.Infinity, true, false));
        ...
        AllItem[0].Add(9,Item.CreateItem("Proteine", "Ah oui ?", CommonImage, prot, Effect.Prot, true, false));
        AllItem[0].Add(10,Item.CreateItem("Toile d'araignees", "Très utile, en soie", Toile, CommonImage, Effect.Toile, true, false));
        ...
        AllItem[1].Add(1,Item.CreateItem("Trefle à quatre feuilles",   "Il finira probablement dans l'herbier de votre grand-mère",RareImage, trefle,Effect.trèfle,  true,  false));
        ...
        AllItem[1].Add(5,Item.CreateItem("Lunette de visee", "C'est l'effet boule de neige !", RareImage, snipe, Effect.Snipe, true, false));
        ...
        AllItem[2].Add(3,Item.CreateItem("Cape de trahison", "Tu es invisible Harry",EpicImage, Cape, Effect.Cape, true, false));
